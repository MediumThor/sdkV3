...
})(exports.AirdropType || (exports.AirdropType = {}));
...
})(exports.ChefType || (exports.ChefType = {}));
...
var CHAINS = (_CHAINS = {}, _CHAINS[exports.ChainId.FUJI] = AVALANCHE_FUJI, _CHAINS[exports.ChainId.AVALANCHE] = AVALANCHE_MAINNET, _CHAINS[exports.ChainId.WAGMI] = WAGMI_FUJI_SUBNET, _CHAINS[exports.ChainId.COSTON] = COSTON_TESTNET, _CHAINS[exports.ChainId.SONGBIRD] = SONGBIRD_CANARY, _CHAINS[exports.ChainId.NEAR_MAINNET] = NEAR_MAINNET, _CHAINS[exports.ChainId.NEAR_TESTNET] = NEAR_TESTNET, _CHAINS);
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.FUJI] = CHAINS[exports.ChainId.FUJI].contracts.factory, _FACTORY_ADDRESS[exports.ChainId.AVALANCHE] = CHAINS[exports.ChainId.AVALANCHE].contracts.factory, _FACTORY_ADDRESS[exports.ChainId.WAGMI] = CHAINS[exports.ChainId.WAGMI].contracts.factory, _FACTORY_ADDRESS[exports.ChainId.COSTON] = CHAINS[exports.ChainId.COSTON].contracts.factory, _FACTORY_ADDRESS[exports.ChainId.SONGBIRD] = CHAINS[exports.ChainId.SONGBIRD].contracts.factory, _FACTORY_ADDRESS[exports.ChainId.NEAR_MAINNET] = CHAINS[exports.ChainId.NEAR_MAINNET].contracts.factory, _FACTORY_ADDRESS[exports.ChainId.NEAR_TESTNET] = CHAINS[exports.ChainId.NEAR_TESTNET].contracts.factory, _FACTORY_ADDRESS);
...
Currency.CURRENCY = (_Currency$CURRENCY = {}, _Currency$CURRENCY[exports.ChainId.FUJI] = /*#__PURE__*/new Currency(18, CHAINS[exports.ChainId.FUJI].symbol, CHAINS[exports.ChainId.FUJI].name), _Currency$CURRENCY[exports.ChainId.AVALANCHE] = /*#__PURE__*/new Currency(18, CHAINS[exports.ChainId.AVALANCHE].symbol, CHAINS[exports.ChainId.AVALANCHE].name), _Currency$CURRENCY[exports.ChainId.WAGMI] = /*#__PURE__*/new Currency(18, CHAINS[exports.ChainId.WAGMI].symbol, CHAINS[exports.ChainId.WAGMI].name), _Currency$CURRENCY[exports.ChainId.COSTON] = /*#__PURE__*/new Currency(18, CHAINS[exports.ChainId.COSTON].symbol, CHAINS[exports.ChainId.COSTON].name), _Currency$CURRENCY[exports.ChainId.SONGBIRD] = /*#__PURE__*/new Currency(18, CHAINS[exports.ChainId.SONGBIRD].symbol, CHAINS[exports.ChainId.SONGBIRD].name), _Currency$CURRENCY[exports.ChainId.NEAR_MAINNET] = /*#__PURE__*/new Currency(24, CHAINS[exports.ChainId.NEAR_MAINNET].symbol, CHAINS[exports.ChainId.NEAR_MAINNET].name), _Currency$CURRENCY[exports.ChainId.NEAR_TESTNET] = /*#__PURE__*/new Currency(24, CHAINS[exports.ChainId.NEAR_TESTNET].symbol, CHAINS[exports.ChainId.NEAR_TESTNET].name), _Currency$CURRENCY); //$ const CAVAX = Currency.CAVAX
...
var WAVAX = (_WAVAX = {}, _WAVAX[exports.ChainId.FUJI] = /*#__PURE__*/new Token(exports.ChainId.FUJI, CHAINS[exports.ChainId.FUJI].contracts.wrapped_native_token, 18, 'WAVAX', 'Wrapped AVAX'), _WAVAX[exports.ChainId.AVALANCHE] = /*#__PURE__*/new Token(exports.ChainId.AVALANCHE, CHAINS[exports.ChainId.AVALANCHE].contracts.wrapped_native_token, 18, 'WAVAX', 'Wrapped AVAX'), _WAVAX[exports.ChainId.WAGMI] = /*#__PURE__*/new Token(exports.ChainId.WAGMI, CHAINS[exports.ChainId.WAGMI].contracts.wrapped_native_token, 18, 'wWAGMI', 'Wrapped WAGMI'), _WAVAX[exports.ChainId.COSTON] = /*#__PURE__*/new Token(exports.ChainId.COSTON, CHAINS[exports.ChainId.COSTON].contracts.wrapped_native_token, 18, 'WCFLR', 'Wrapped CostonFlare'), _WAVAX[exports.ChainId.SONGBIRD] = /*#__PURE__*/new Token(exports.ChainId.SONGBIRD, CHAINS[exports.ChainId.SONGBIRD].contracts.wrapped_native_token, 18, 'wWSGB', 'Wrapped Songbird'), _WAVAX[exports.ChainId.NEAR_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.NEAR_MAINNET, CHAINS[exports.ChainId.NEAR_MAINNET].contracts.wrapped_native_token, 24, 'wNEAR', 'Wrapped NEAR'), _WAVAX[exports.ChainId.NEAR_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.NEAR_TESTNET, CHAINS[exports.ChainId.NEAR_TESTNET].contracts.wrapped_native_token, 24, 'wNEAR', 'Wrapped NEAR'), _WAVAX);
    ...
    for (var i = 0; i < pools.length; i++) {
      ...
      for (var _iterator = _createForOfIteratorHelperLoose(poolTokens), _step; !(_step = _iterator()).done;) {
        ...
        if (amountOut.token.equals(tokenOut)) {
          sortedInsert(bestTrades, new Trade(new Route([].concat(currentPools, [pool]), originalAmountIn.currency, currencyOut, currentHops), originalAmountIn, exports.TradeType.EXACT_INPUT, chainId, {
            fee: fee,
            feeTo: feeTo
    ...
    for (var i = 0; i < pools.length; i++) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(poolTokens), _step2; !(_step2 = _iterator2()).done;) {
        ...
        if (amountIn.token.equals(tokenIn)) {
          sortedInsert(bestTrades, new Trade(new Route([pool].concat(currentPools), currencyIn, originalAmountOut.currency, currentHops), originalAmountOut, exports.TradeType.EXACT_OUTPUT, chainId, {
            fee: fee,
            feeTo: feeTo
          }), maxNumResults, tradeComparator);
        } else if (maxHops > 1 && pools.length > 1) {
...
var Pair = /*#__PURE__*/function (_Pool) {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, chainId) {
    ...
    return !!((_CHAINS$chainId = CHAINS[chainId]) !== null && _CHAINS$chainId !== void 0 && _CHAINS$chainId.evm) ? address.getCreate2Address(FACTORY_ADDRESS[chainId], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH) : tokens[0].address + "-" + tokens[1].address;
  };
  ...
  _createClass(Pair, [{
    ...
    get: function get() {
      switch (this.chainId) {
        case exports.ChainId.NEAR_MAINNET:
        case exports.ChainId.NEAR_TESTNET:
          return _998;
        // 0.2%
...
exports.FLARE_MAINNET = FLARE_MAINNET;
exports.FUSE_MAINNET = FUSE_MAINNET;
exports.FUSE_TESTNET = FUSE_TESTNET;
exports.Fetcher = Fetcher;
exports.Fraction = Fraction;
exports.GODWOKEN_MAINNET = GODWOKEN_MAINNET;
exports.GODWOKEN_TESTNET = GODWOKEN_TESTNET;
...
exports.MIN_RESERVE = MIN_RESERVE;
...
exports.NEAR_MAINNET = NEAR_MAINNET;
exports.NEAR_TESTNET = NEAR_TESTNET;
...
exports.SHIDEN_MAINNET = SHIDEN_MAINNET;
exports.SONGBIRD_CANARY = SONGBIRD_CANARY;
exports.TARGET_DECIMAL = TARGET_DECIMAL;
